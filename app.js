    ...
    ${list.length? `<div class="table-wrap"><table><thead><tr><th>Date</th><th>Motif</th><th>Montant</th><th>Mode</th><th></th></tr></thead><tbody>
      ${list.map(e=>`<tr>
        ...
        <td><span style="display:flex;gap:6px;">
          ...
          <button class="btn btn-ghost btn-sm" data-action="edit-expense" data-id="${e.id}">✏️</button>
          <button class="btn btn-danger btn-sm" data-action="delete-expense" data-id="${e.id}">🗑️</button>
        </span></td>
      </tr>`).join("")}
    ...
    ${list.length? `<div class="table-wrap"><table><thead><tr><th>Date</th><th>Motif</th><th>Montant</th><th>Mode</th><th></th></tr></thead><tbody>
      ${list.map(r=>`<tr>
        ...
        <td><span style="display:flex;gap:6px;">
          ...
          <button class="btn btn-ghost btn-sm" data-action="edit-revenue" data-id="${r.id}">✏️</button>
          <button class="btn btn-danger btn-sm" data-action="delete-revenue" data-id="${r.id}">🗑️</button>
        </span></td>
      </tr>`).join("")}
...
function onAppClick(e){
  ...
  switch(action){
    ...
    case "edit-expense": modalState={type:"editExpense", id}; render(); break;
    ...
    case "edit-revenue": modalState={type:"editRevenue", id}; render(); break;
