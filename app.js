...
function topBarHTML(title){
  return `<div class="topbar no-print"><div class="wrap topbar-inner">
    <div class="logo">${logoBadgeHTML()}<div class="logo-text">
...
function spaceHTML(sp){
  ...
  return topBarHTML(title) + tabsHTML(tabs, secTab) + `<div class="wrap" style="padding:16px 16px 60px;">${body}</div>`;
}
...
function submitPin(){
  ...
  if(code===expected){
    role = modalState.mode; secTab = role==="admin" ? "dashboard" : "eleves"; screen=null; modalState=null; render();
...
function onAppClick(e){
  ...
  switch(action){
    ...
    case "exit-role": role=null; screen=null; modalState=null; secTab="eleves"; eleveFiliereId=null; render(); break;
    ...
    case "set-tab": secTab = btn.dataset.tab; screen=null; render(); break;
