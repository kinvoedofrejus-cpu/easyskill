...
/* Calcule la date d'expiration à partir du type de durée, à compter de maintenant
   (sauf pour "date" qui utilise une date fixe choisie à la génération). */
function computeExpiresAt(issued){
  const now = new Date();
